...
### BEGIN INIT INFO
# Provides:          vmware-desktop-autoscaler-utility
# Required-Start:    $remote_fs $syslog
# Required-Stop:     $remote_fs $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: VMware desktop autoscaler Utility Service
# Description:       Provides the VMWare Desktop REST API for autoscaler
### END INIT INFO
...
const SYSV_PATH = "/etc/init.d/vmware-desktop-autoscaler-utility"
